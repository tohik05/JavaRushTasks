...
public class Solution {
    public static void main(String[] args) {
        try {
            File yourFile = new File("C:\\Users\\Тоха\\Desktop\\testjava.txt");
    ...
    public static class JavaRush {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if (users.size() > 0) {
                for (User current : this.users) {
                    ...
                    printWriter.println(current.getBirthDate().getTime());
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            while(reader.ready()) {
                ...
                user.setCountry(User.Country.valueOf(reader.readLine().toUpperCase(Locale.ROOT)));
                this.users.add(user);
            }
            reader.close();
        }
